...
def imprimir_mensaje_enmarcado(mensaje, color='\033[36m'):
    ancho = len(mensaje) + 4
    print(color + 'x' * ancho)
    print()
    print(f'  {mensaje}')
    print()
    print('x' * ancho + '\033[0m')
...
def imprimir_mensaje_continuar(mensaje):
    ...
    imprimir_mensaje_enmarcado(mensaje, color='\033[36m')
...
if __name__ == "__main__":
    while True:
        ...
        zona_horaria_local = pytz.timezone('America/Buenos_Aires')  # Cambia 'America/Buenos_Aires' por la zona horaria de tu ubicación
        ...
        imprimir_mensaje_enmarcado("Ingrese el número del día del archivo que desea abrir (31-40)", '\033[36m') 
